...
// Diagnostics helper to probe the Netlify proxy function
...
export default function App() {
  ...
  // Live & Signals: immediate fetch + WS subscribe
  useEffect(() => {
  ...
  // Auto-diagnostics when Signals tab opens
  useEffect(() => {
